  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          Ocurrió un error de nuestro lado. Puedes intentar de nuevo o volver al inicio.
        </p>
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Rastreo GPS satelital en tiempo real para tu vehículo o flota." },
      { name: "author", content: "ORB-LITE" },
      { property: "og:title", content: "ORB-LITE | Rastreo GPS Satelital" },
      { property: "og:description", content: "Rastreo GPS satelital en tiempo real para tu vehículo o flota." },
