...
export const PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    category: "RENOVATION",
    description:
      "Mantén activo tu servicio: renueva la plataforma ORB-LITE (anual) o ORB-FULL (mensual o anual) y los datos de tu chip.",
    ...
    variants: [
      ...
      },
      {
        ...
        badge: "Ahorra $50",
        includes: [
          "Acceso a plataforma ORB-FULL por 1 mes",
          "SIM 30MB mensuales por 1 año (M2M)",
        ],
        renewal_kind: "both",
        renewal_period: "monthly",
      ...
      },
      {
        ...
        badge: "Ahorra $50",
        includes: [
          "Acceso a plataforma ORB-FULL por 1 año",
          "SIM 30MB mensuales por 1 año (M2M)",
        ],
        renewal_kind: "both",
        renewal_period: "annual",
